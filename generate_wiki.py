...
<div class="wiki-page">
  ...
  <div class="site-notice">
    ...
    <p>이 위키는 교육부 보도자료를 바탕으로 <strong>격주</strong>로 업데이트됩니다. 업데이트되면 이 페이지에 <strong>자동으로 최신 내용이 반영</strong>되므로, 새 링크를 받을 필요 없이 지금 이 주소를 그대로 저장해두고 보시면 됩니다(반영까지 최대 10분 정도 걸릴 수 있어요).</p>
    <p>
